<template>
  <div class="row">
    ...
    <div class="column-12 column-center text-center gutter-top" v-if="selectedTestimonies.length > 0">
      <div class="box-person column-3" v-for="item in selectedTestimonies" :key="item.id">
        <div class="box-avatar"><img :src="item.image" :alt="item.name" class="avatar"/></div>
        <div class="box-testimony">
          <p class="testimony"><span class="who">{{ item.name }}</span>: <i>"{{ item.testimony }}"</i></p>
        </div>
      </div>
    </div>
  </div>
    ...
    return {
      testimonies: [
        ...
        },
        {
          ...
          testimony: 'me patió porque me demoraba mucho en llegar a su casa'
        },
        {
          name: '@keldor',
        ...
        },
        {
          ...
          testimony: 'cámbiense antes que los echen'
        },
        {
          name: '@alex',
        ...
        },
        {
          ...
          testimony: 'una vez estaba vendiendo una bicicleta y me dijeron que me daban la mitad porque era como de playa y la playa estaba lejos 😞'
        },
        {
          name: '@fabian',
